...
describe('array', () => {
  describe('removeAllMut', () => {
    ...
    it('does nothing when the array is empty', () => {
      const array: number[] = [];
      array_.removeAllMut(array, [1, 2, 3]);
      expect(array).toEqual([]);
    });

    it('does nothing when the values array is empty', () => {
      const array = [1, 2, 3];
      array_.removeAllMut(array, []);
    ...
    it('returns undefined', () => {
      const array = [1, 2, 3];
      const result = array_.removeAllMut(array, [1]);
    ...
    it('works with object references', () => {
      ...
      array_.removeAllMut(array, [obj1, obj3]);
