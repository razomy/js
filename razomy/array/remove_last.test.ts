...
describe('array', () => {
  describe('removeLast', () => {
    ...
    it('works with arrays of strings', () => {
      expect(removeLast(['hello', 'world', 'foo'])).toEqual(['hello', 'world']);
    });
  });
});
