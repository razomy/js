...
export const videos: FileFormat[] = [
  // --- WEB & MODERN ---
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-video',
    conversions: videoConversions.filter(c => c !== 'mp4')
  },
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-video',
    conversions: videoConversions.filter(c => c !== 'webm')
  },
  {
    ...
    conversions: videoConversions.filter(c => c !== 'mov')
  },
  {
    ...
    conversions: videoConversions.filter(c => c !== 'mkv')
  },
  ...
  // --- PC & LEGACY ---
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-video-outline',
    conversions: videoConversions.filter(c => c !== 'avi')
  },
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-windows',
    conversions: videoConversions.filter(c => c !== 'wmv')
  },
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-windows',
    conversions: videoConversions.filter(c => c !== 'asf')
  }, // Предшественник WMV
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-flash',
    conversions: videoConversions.filter(c => c !== 'flv')
  },
  {
    ...
    conversions: videoConversions.filter(c => c !== 'swf')
  }, // Flash
  ...
  // --- MOBILE & APPLE ---
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-apple',
    conversions: videoConversions.filter(c => c !== 'm4v')
  },
  {
    ...
    conversions: videoConversions.filter(c => c !== '3gp')
  },
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-cellphone',
    conversions: videoConversions.filter(c => c !== '3g2')
  },
  ...
  // --- DISC & BROADCAST (DVD, BluRay, TV) ---
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-disc',
    conversions: videoConversions.filter(c => c !== 'vob')
  }, // DVD
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-disc',
    conversions: videoConversions.filter(c => c !== 'mpg')
  },
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-disc',
    conversions: videoConversions.filter(c => c !== 'mpeg')
  },
  {
    ...
    conversions: videoConversions.filter(c => c !== 'm2ts')
  }, // Blu-ray
  {
    ...
    conversions: videoConversions.filter(c => c !== 'mts')
  }, // AVCHD Camcorders
  {
    ...
    conversions: videoConversions.filter(c => c !== 'ts')
  }, // IPTV Stream
  {
    ...
    conversions: videoConversions.filter(c => c !== 'mxf')
  }, // Профессиональное ТВ
  ...
  // --- OTHERS ---
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-video',
    conversions: videoConversions.filter(c => c !== 'ogv')
  },
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-history',
    conversions: videoConversions.filter(c => c !== 'rm')
  }, // RealMedia (90s)
  {
    ...
    fileCategory: 'video',
    iconUrl: 'mdi-history',
    conversions: videoConversions.filter(c => c !== 'rmvb')
  },
  {
    ...
    conversions: videoConversions.filter(c => c !== 'dv')
