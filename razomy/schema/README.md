...
[![TypeScript](https://img.shields.io/npm/types/@razomy/schema)](https://www.npmjs.com/package/@razomy/schema)
[![Node.js Version](https://img.shields.io/node/v/@razomy/schema)](https://www.npmjs.com/package/@razomy/schema)
...
[![License](https://img.shields.io/npm/l/@razomy/schema)](https://github.com/razomy/js/blob/main/LICENSE)

[![CI Status](https://github.com/razomy/js/actions/workflows/release.yml/badge.svg)](https://github.com/razomy/js/actions)
[![npm version](https://img.shields.io/npm/v/@razomy/schema)](https://www.npmjs.com/package/@razomy/schema)
[![minzipped size](https://img.shields.io/bundlephobia/minzip/@razomy/schema)](https://bundlephobia.com/package/@razomy/schema)
[![GitHub stars](https://img.shields.io/github/stars/razomy/js?style=social)](https://github.com/razomy/js/stargazers)
[![npm downloads](https://img.shields.io/npm/dw/@razomy/schema)](https://www.npmjs.com/package/@razomy/schema)

[Npm](https://www.npmjs.com/package/@razomy/schema) |
[Npmx](https://npmx.dev/package/@razomy/schema) |
[GitHub](https://github.com/razomy/js/tree/main/razomy/schema) |
[Razomy Io](https://io.razomy.org/schema) |
[Razomy Cli](https://github.com/razomy/cli)

> A lightweight wrapper and unified interface for seamless schema validation
...
npm i @razomy/schema
# or
bun add @razomy/schema
# or
razomy cli add @razomy/schema
```
...
// or
import * as schema from "npm:@razomy/schema";
// or
import * as schema from "https://esm.sh/@razomy/schema";
// or
import * as schema from "https://unpkg.com/@razomy/schema";
// or
import { functionName } from '@razomy/schema';
// or
razomy run @razomy/schema functionName
```
