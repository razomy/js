...
export function functionPipe<A, B, C, D, E>(
  fn1: Unary<A, B>,
  fn2: Unary<B, C>,
  fn3: Unary<C, D>,
  fn4: Unary<D, E>,
): (a: A) => E;
export function functionPipe<A, B, C, D, E, F>(
  fn1: Unary<A, B>,
  fn2: Unary<B, C>,
  fn3: Unary<C, D>,
  fn4: Unary<D, E>,
...
export function functionPipe<A, B, C, D, E, F, G>(
  fn1: Unary<A, B>,
  fn2: Unary<B, C>,
  fn3: Unary<C, D>,
  fn4: Unary<D, E>,
...
export function functionPipe<A, B, C, D, E, F, G, H>(
  fn1: Unary<A, B>,
  fn2: Unary<B, C>,
  fn3: Unary<C, D>,
  fn4: Unary<D, E>,
...
export function functionPipe<A, B, C, D, E, F, G, H, I>(
  fn1: Unary<A, B>,
  fn2: Unary<B, C>,
  fn3: Unary<C, D>,
  fn4: Unary<D, E>,
