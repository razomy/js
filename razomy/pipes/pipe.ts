import type { Alias } from '@razomy/abstracts/codes';
...
export async function pipe<T, A, B, C, D>(
  arg: T,
  f1: PipeAsync<T, A>,
  f2: PipeAsync<A, B>,
  f3: PipeAsync<B, C>,
...
export async function pipe<T, A, B, C, D, E>(
  arg: T,
  f1: PipeAsync<T, A>,
  f2: PipeAsync<A, B>,
  f3: PipeAsync<B, C>,
...
export async function pipe<T, A, B, C, D, E, F>(
  arg: T,
  f1: PipeAsync<T, A>,
  f2: PipeAsync<A, B>,
  f3: PipeAsync<B, C>,
...
export async function pipe<T, F>(
  arg: T,
  ...fns: [PipeAsync<T, any>, ...PipeAsync<any, any>[], PipeAsync<any, F>]
): Promise<F>;
