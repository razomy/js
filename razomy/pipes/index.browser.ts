export { fp, type BaseChain, type StringChainMethods, type ArrayChainMethods, type Chain, type StripFirstArg, type Chainable, ChainRegistry } from './chain_registry';
