...
export function filter<V>(input: abstracts.structures.Value<V>, isKeep: abstracts.functions.Function<[abstracts.structures.Value<V>], boolean>): abstracts.structures.Value<V>;
export function filter<K, V>(
  input: abstracts.structures.KeyValueArray<K, V>,
  isKeep: abstracts.functions.Function<[abstracts.structures.KeyValueArray<K, V>], boolean>,
): abstracts.structures.KeyValueArray<K, V>;
export function filter<K, V>(
  value: abstracts.structures.KeyValueArray<K, V> | abstracts.structures.KeyValue<K, V>,
  isKeep: abstracts.functions.Function<[abstracts.structures.KeyValueArray<K, V> | abstracts.structures.KeyValue<K, V>], boolean>,
