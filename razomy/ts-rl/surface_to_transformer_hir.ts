...
export class SurfaceToTransformerHir {
  ...
  public transform(node: abstracts.translators.AstNode): abstracts.translators.NodeHir {
    ...
    switch (node.kind) {
      ...
      case 'FunctionAst': {
        const n = node as abstracts.translators.FunctionAst;
        const symbolId = this.env.define(n.identifier.name);
      ...
      case 'PropertyAst': {
        const n = node as abstracts.translators.PropertyAst;
    ...
    switch (node.kind) {
      ...
      case 'FunctionShape': {
        ...
        return {
          ...
          returnShape: n.returnShape ? this.transformShape(n.returnShape.shape) : {
