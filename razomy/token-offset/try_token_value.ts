...
export function tryTokenValue<TToken extends WithTokenType<any> & WithValue<string>, TTokenType extends TToken['tokenType']>(ctx: WithTokens<TToken> & WithOffset, targetType: TTokenType) {
