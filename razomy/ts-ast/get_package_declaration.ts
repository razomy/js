...
export function getPackageDeclaration(project: Project, dirPath: string, onlyPublic: boolean = true): abstracts.ast.PackageDeclaration {
  ...
  } satisfies abstracts.ast.PackageDeclaration;
