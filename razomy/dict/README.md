...
`filter(dict: import("/Volumes/resource/resource/razomy/code/js.chunk/razomy/dict/dict").Dict<T>, predicate: (value: T, key: string) => boolean): import("/Volumes/resource/resource/razomy/code/js.chunk/razomy/dict/dict").Dict<T>`
...
`isKeys(dict: import("/Volumes/resource/resource/razomy/code/js.chunk/razomy/dict/dict").Dict<T>, keys: readonly string[]): boolean`
...
`toString_(dict: import("/Volumes/resource/resource/razomy/code/js.chunk/razomy/dict/dict").Dict<T>): string`
