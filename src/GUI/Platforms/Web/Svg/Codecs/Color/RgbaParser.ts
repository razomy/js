export class RgbaParser {
   ...
   */
  public static toRgba(source: [number, number, number, number]) {
   ...
   * @return {Color}
   */
  public static fromRgb(color: string) {
    return (this.sourceFromRgb(color));
  };
   ...
   * @return {Array} source
   */
  public static sourceFromRgb(color: string) {
