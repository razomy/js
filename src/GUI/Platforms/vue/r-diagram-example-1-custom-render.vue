<template>
  <div ref='razomyDiagramContainer' class='razomy-diagram-container'> {{ 'Razomy diagram not loaded!' }}</div>
</template>
...
import { RenderFactory, WebCanvasRender } from '../../../GUI/Platforms/Web/Canvas/Renders/WebCanvasRender';
import { WebSvgCodec } from '../../../GUI/Platforms/Web/Svg/Codecs/WebSvgCodec';
import { WebSvgRender } from '../../../GUI/Platforms/Web/Svg/Renders/SvgDomRender';
import { WebSvgHighLightsRender } from '../../../GUI/Platforms/Web/Svg/Renders/WebSvgHighLightsRender';
import { WebSvgContext } from '../../../GUI/Platforms/Web/Svg/WebSvgContext';
...
@Component
export default class RazomyDiagram extends Vue {
  ...
  public mounted(): void {
    ...
    if (this.renderStrategy === 'svg') {
      ...
      this.render = new WebSvgRender(
        ...
        webSvgContext.codecFactory,
        webSvgContext.codecRegistry,
        this.$refs.razomyDiagramContainer as Node,
      ...
      canvas.width = 300;
      canvas.height = 300;
      (this.$refs.razomyDiagramContainer as HTMLDivElement).appendChild(canvas);
  ...
  private clearRoot(): void {
    const myNode = this.$refs.razomyDiagramContainer as any;
