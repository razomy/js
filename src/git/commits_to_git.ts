...
export async function init_commits_to_git(dir_path: string, file_name: string, commits: Commit[]) {
...
export async function commits_to_git(prev_snapshot: string, dir_path: string, file_name: string, commits: Commit[]) {
