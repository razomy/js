import { WebCanvasHighLightsRender }  from 'razomy.graphics/codecs/web/canvas/renders/web_canvas_highlights_render';
...
export class RenderFactory implements create.With<IRender<any>> {
