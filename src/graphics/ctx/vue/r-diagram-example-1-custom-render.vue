...
<script lang='ts'>
import { ElementView } from '../../graphics/elements/element-view';
import { WebCanvasHighLightsRender } from '../web/canvas/renders/web-canvas-highlights-render';
import { RenderFactory, WebCanvasRender } from '../web/canvas/renders/web-canvas-render';
import { WebSvgCodec } from '../web/svg/codecs/web-svg-codec';
import { WebSvgRender } from '../web/svg/renders/svg-dom-render';
import { WebSvgHighLightsRender } from '../web/svg/renders/web-svg-highlights-render';
import { WebSvgContext } from '../web/svg/web-svg-context';
